...
//    ResultSet resultSet = null;
    String strSever = "TRANAN3110\\SQLEXPRESS";
    String strDatabase = "QuanLyNhaHang1";
      String username = "sa"; // Thay "your_username" bằng tên đăng nhập của bạn
    String password = "123"; // Thay "your_password" bằng mật khẩu của bạn
    public void open () {
    try {
